    ...
    render() {
        return (
            <div id="holidays-page">
                <h2>Holidays</h2>
                <p>Select the country you want to see holiday information about. A request is made to our rest server, and then to the <a href="https://date.nager.at/">Public Holidays</a> api.</p>
